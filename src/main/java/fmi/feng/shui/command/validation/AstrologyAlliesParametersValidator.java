...
public class AstrologyAlliesParametersValidator extends CommandParametersValidator {
	...
	/**
	 * Constructs a validator for the astrology allies Feng Shui command with the
	 * raw parameters, specified by the user
	 */
	public AstrologyAlliesParametersValidator(List<String> parameters) {
		super(parameters);
