...
public class SecretFriendParametersValidatorTest {
	...
	public void test_should_verify_valid_parameters_count_validation() throws InvalidParametersCountException {
		SecretFriendParametersValidator validator = new SecretFriendParametersValidator(Arrays.asList(VALID_PARAMETER));
	...
	public void test_should_verify_invalid_parameters_count_validation() throws InvalidParametersCountException {
		SecretFriendParametersValidator validator = new SecretFriendParametersValidator(
